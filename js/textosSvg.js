 const infoBox = document.getElementById("infoBox");
  ...
  const rooms = {
    ...
    musica: "Esses hobbies podem ser integrados à rotina sem precisar sair de casa. Para música, escolha um instrumento simples, como teclado ou violão, e pratique um pouco todos os dias. Praticar arte em casa exige apenas materiais básicos e vontade de experimentar. Para pintura, comece com lápis, aquarela ou tinta acrílica em papéis ou telas pequenas. Para escultura, massinha de modelar ou argila são ótimas para iniciantes. O mais importante é se permitir errar e explorar diferentes estilos, cores e formas. Procure tutoriais online ou livros de arte para aprender técnicas, mas não se pressione por resultados perfeitos, o objetivo é se expressar e se divertir.",
